...
export class EnvCredentialSource implements CredentialSource {
  ...
  constructor(private readonly env: Record<string, string | undefined>, private readonly map: Record<string, string>) {}
  available(): boolean { return Object.keys(this.map).length > 0; }
