...
export class Idea extends KnowledgeNote {
  ...
  get stage(): string { return this.frontmatter.stage ?? "seed"; }
  get impact(): string { return this.frontmatter.impact ?? "medium"; }
  get effort(): string { return this.frontmatter.effort ?? "medium"; }
