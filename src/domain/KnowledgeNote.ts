...
export class KnowledgeNote extends Entity {
  ...
  get org(): string | null { return this.frontmatter.org ?? null; }
  get topic(): string | null { return this.frontmatter.topic ?? null; }
  get confidence(): string { return this.frontmatter.confidence ?? "medium"; }
}
