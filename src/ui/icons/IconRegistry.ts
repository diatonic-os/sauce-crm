...
const CUSTOM_ICONS: ReadonlyArray<{ name: string; svg: string }> = [
  ...
  { name: "sauce-note",         svg: '<rect x="22" y="14" width="56" height="72" rx="6" fill="none" stroke="currentColor" stroke-width="6"/><path d="M34 34 L66 34 M34 48 L66 48 M34 62 L56 62" stroke="currentColor" stroke-width="5" stroke-linecap="round"/>' },
  { name: "sauce-idea",         svg: '<path d="M36 58 Q24 46 28 32 Q34 14 50 14 Q66 14 72 32 Q76 46 64 58 Q60 62 60 70 L40 70 Q40 62 36 58 Z" fill="none" stroke="currentColor" stroke-width="6" stroke-linejoin="round"/><path d="M42 84 L58 84 M42 76 L58 76" stroke="currentColor" stroke-width="5" stroke-linecap="round"/>' },
  { name: "sauce-observation",  svg: '<path d="M12 50 Q50 18 88 50 Q50 82 12 50 Z" fill="none" stroke="currentColor" stroke-width="6"/><circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" stroke-width="6"/>' },
  { name: "sauce-task",         svg: '<rect x="18" y="18" width="64" height="64" rx="8" fill="none" stroke="currentColor" stroke-width="6"/><path d="M32 50 L44 62 L70 34" stroke="currentColor" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" fill="none"/>' },
  { name: "sauce-event",        svg: '<rect x="18" y="24" width="64" height="58" rx="6" fill="none" stroke="currentColor" stroke-width="6"/><path d="M18 42 L82 42 M34 14 L34 30 M66 14 L66 30" stroke="currentColor" stroke-width="6" stroke-linecap="round"/><circle cx="38" cy="58" r="4" fill="currentColor"/><circle cx="54" cy="58" r="4" fill="currentColor"/>' },
  { name: "sauce-ledger",       svg: '<rect x="18" y="16" width="64" height="68" rx="4" fill="none" stroke="currentColor" stroke-width="6"/><path d="M32 34 L68 34 M32 50 L68 50 M32 66 L50 66" stroke="currentColor" stroke-width="5" stroke-linecap="round"/><path d="M62 62 L74 74" stroke="currentColor" stroke-width="5" stroke-linecap="round"/>' },
  { name: "sauce-pipeline",     svg: '<path d="M16 24 H84 L64 50 V76 L36 86 V50 Z" fill="none" stroke="currentColor" stroke-width="6" stroke-linejoin="round"/><path d="M30 36 H70" stroke="currentColor" stroke-width="5" stroke-linecap="round"/>' },
];
