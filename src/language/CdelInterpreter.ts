...
export interface CdelDispatch {
  skillId: string;
  args: Record<string, unknown>;
  source: "directive" | "natural";
}
export interface CdelInterpretResult {
...
export class CdelInterpreter {
  constructor(
    private readonly idioms = new IdiomCatalog(),
    private readonly strictness: "warn" | "block" | "best-guess" = "best-guess",
  ) {}
