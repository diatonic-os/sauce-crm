...
export const DEFAULT_SLASH_COMMANDS: SlashCommand[] = [
  {
    ...
    prompt:
      "Fix the grammar and spelling of the following, preserving meaning and tone:\n\n{}",
    inMenu: true,
    slashCmd: true,
  },
  {
    ...
    name: "Translate",
    prompt:
      "Translate the following into the requested language (ask if unspecified):\n\n{}",
    inMenu: true,
    slashCmd: true,
  },
  {
  ...
  },
  {
    id: "simplify",
    name: "Simplify",
    prompt: "Rewrite the following in simpler language:\n\n{}",
    inMenu: true,
    slashCmd: true,
  },
  {
    ...
    prompt: "Explain the following as if to a five-year-old:\n\n{}",
    inMenu: true,
    slashCmd: true,
  },
  {
    ...
    name: "Emojify",
    prompt:
      "Add tasteful, relevant emoji to the following without changing the wording:\n\n{}",
    inMenu: true,
    slashCmd: true,
  },
  {
    ...
    name: "Make shorter",
    prompt:
      "Make the following more concise while keeping the key points:\n\n{}",
    inMenu: true,
    slashCmd: true,
  },
  {
    id: "make-longer",
    name: "Make longer",
    prompt: "Expand the following with more detail and examples:\n\n{}",
    inMenu: true,
    slashCmd: true,
  },
  {
    ...
    prompt: "Generate a Markdown table of contents for the following:\n\n{}",
    inMenu: false,
    slashCmd: false,
  },
  {
    ...
    prompt: "Generate a glossary of key terms from the following:\n\n{}",
    inMenu: false,
    slashCmd: false,
  },
  {
    ...
    name: "Remove URLs",
    prompt:
      "Remove all URLs from the following, keeping everything else intact:\n\n{}",
    inMenu: false,
    slashCmd: false,
  },
  {
    ...
    prompt:
      "Rewrite the following as a single engaging tweet (<280 chars):\n\n{}",
    inMenu: false,
    slashCmd: false,
  },
  {
    ...
    prompt: "Rewrite the following as a numbered tweet thread:\n\n{}",
    inMenu: false,
    slashCmd: false,
  },
];
