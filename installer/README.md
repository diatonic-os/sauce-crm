...
5. **Install the plugin into the vault:** create
   ...
   `manifest.json`, `styles.css` from the **0.4.1** release and
...
- `main.js`, `manifest.json`, `styles.css` —
  `https://github.com/Diatonic-OS/sauce-crm/releases/download/0.4.1/{…}`
- `versions.json` —
  `https://raw.githubusercontent.com/Diatonic-OS/sauce-crm/0.4.1/versions.json`
