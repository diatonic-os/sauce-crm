...
#   5. Installs the Sauce CRM plugin (0.4.1) into
...
#
# ASSUMPTIONS
#   - The 0.4.1 release assets (main.js, manifest.json, styles.css) and the
#     0.4.1 raw versions.json exist at the documented URLs.
